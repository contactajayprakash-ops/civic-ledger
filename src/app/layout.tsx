...
export const metadata: Metadata = {
  title: { default: "Civic Ledger", template: "%s · Civic Ledger" },
  description:
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://civic-ledger.vercel.app"),
  openGraph: {
    title: "Civic Ledger",
    description: "What your city council decided, in plain language.",
    type: "website",
  },
};
